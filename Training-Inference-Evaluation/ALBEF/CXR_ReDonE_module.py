...
class RETRIEVAL_MODULE:
    ...
    def __init__(self, 
        ...
        self.transform = transforms.Compose([transforms.Resize((input_resolution,input_resolution),
                                             ...
                                             transforms.Normalize((0.58740044, 0.58740044, 0.58740044), (0.27710825, 0.27710825, 0.27710825))])
        self.dset = CXRTestDataset(transform=self.transform, img_path=img_path)  
